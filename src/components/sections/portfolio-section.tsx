...
const PortfolioCard = ({ project, onClick }: { project: PortfolioProject; onClick: () => void }) => {
  return (
    <motion.div
      layout
...
const ProjectDetailsModal = ({ project, isOpen, onClose }: { project: PortfolioProject | null; isOpen: boolean; onClose: () => void }) => {
      ...
      <DialogContent className="max-w-[100vw] sm:max-w-[90vw] xl:max-w-7xl h-[100vh] sm:h-[90vh] overflow-hidden bg-[#050505] border-white/5 text-white p-0 shadow-2xl rounded-none sm:rounded-[48px] outline-none z-[10001]">
        <div className="flex flex-col h-full overflow-y-auto custom-scrollbar">
          <div className="relative flex flex-col lg:flex-row h-full">
            <div className="relative w-full lg:w-1/2 h-[40vh] lg:h-full">
              <Image
                src={project.image}
                alt={project.title}
                fill
              ...
              <div className="max-w-xl mx-auto lg:mx-0 space-y-16">
                ...
                <div className="grid grid-cols-1 gap-12">
                  <section className="space-y-6">
                    ...
                    <p className="text-xl md:text-2xl text-white/90 leading-snug font-medium">
                  ...
                  <section className="pt-12 border-t border-white/5 space-y-10">
                    <div className="grid grid-cols-2 gap-10">
                      <div>
                        ...
                        <p className="text-xl font-black text-white">{project.client}</p>
                        <p className="text-white/40 text-xs font-medium">{project.useCase}</p>
                      </div>
                      <div>
